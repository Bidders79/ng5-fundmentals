...
/*
    ...
    Promise  = a single event
                always calls the success or failed callback even if it isn't required


    observable = handles zero or more events, the callback is called for each of these events
                 an array of items that arrive asynchronously over time
                 can be cancelled
                 provides operators to handle and alter the returning data, like an array - map, forEach and reduce..
                 its like async/await - allowing for flat code and not methods chained together.
                 makes use of the Reactive Extension RxJS
*/
